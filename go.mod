...
require (
	...
	github.com/grafana/alerting v0.0.0-20260226210840-9640967a1c7f // @grafana/alerting-backend
	...
	github.com/grpc-ecosystem/grpc-gateway/v2 v2.27.8 // @grafana/identity-access-team
